...
import { ArrowLeft, Pencil, BookOpen, Clock, Award } from "lucide-react";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Detailed overview of scheduled examination
            </p>
          </div>
        </div>

        <Link href={`/exams/${examId}/edit`} passHref legacyBehavior>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border p-5 flex items-start gap-4">
            ...
            <div>
              ...
              <h4 className="font-bold text-lg mt-1">{exam.subject}</h4>
