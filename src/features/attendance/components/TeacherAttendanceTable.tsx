                ...
                <TableRow>
                  <TableCell colSpan={6}>
                    <EmptyState
                      ...
                      description="Start by marking teacher attendance or adjust your filters."
                    />
                  </TableCell>
                </TableRow>
              ) : (
          ...
          {viewRecord && (
            <div className="space-y-4 pt-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <span className="text-xs text-muted-foreground block">Teacher Name</span>
                ...
                <div>
                  ...
                  <span className="font-semibold text-sm">
                    {typeof viewRecord.entityId === "object" ? viewRecord.entityId.employeeId : "—"}
                  </span>
                </div>
                <div>
                  <span className="text-xs text-muted-foreground block">Department</span>
                  <span className="font-semibold text-sm">
                    {typeof viewRecord.entityId === "object" ? viewRecord.entityId.department : "—"}
                  </span>
                </div>
                <div>
